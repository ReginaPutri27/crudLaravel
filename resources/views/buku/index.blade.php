...
@section('content')
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        <h4>Buku Perpustakan</h4>
      </div>
      <div class="col-sm-2">
        <a class="btn btn-sm btn-success" href="{{ route('buku.create') }}">Tambah Daftar Buku</a>
      </div>
    </div>
        ...
        <tr>
          ...
          <td>
            <form action="{{ route('buku.destroy', $buku->id) }}" method="post">
              <a class="btn btn-sm btn-success" href="{{route('buku.show', $buku->id)}}">View</a>
